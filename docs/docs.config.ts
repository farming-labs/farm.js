...
const icons = {
  ...
  "brand-nextjs": brandPath(siNextdotjs.path),
  "brand-nuxt": brandPath(siNuxt.path),
...
const sidebar = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Built-in DevTools", slug: "devtools", icon: "monitor" },
      { label: "Doctor", slug: "doctor", icon: "wrench" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Next.js", slug: "migrations/nextjs", icon: "brand-nextjs" },
      { label: "SvelteKit", slug: "migrations/sveltekit", icon: "brand-svelte" },
      { label: "Nuxt", slug: "migrations/nuxt", icon: "brand-nuxt" },
      { label: "TanStack Start", slug: "migrations/tanstack", icon: "brand-tanstack" },
    ],
  },
  {
    label: "Reference",
