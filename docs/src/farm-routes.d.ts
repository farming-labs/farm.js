 ...
 */
export type RoutePath = "/" | "/docs" | "/docs/api-client" | "/docs/getting-started" | "/docs/layouts" | "/docs/plugins" | "/docs/plugins/create-plugin" | "/docs/query" | "/docs/routing" | "/docs/storage";
