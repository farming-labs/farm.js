    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-slate-600">
          Layouts wrap pages and persist across navigations. Use them for shared UI like headers and
          sidebars.
        </p>
      </div>
      ...
      <section>
        ...
        <p className="mt-2 text-slate-600">
          ...
          is the root layout. It wraps every page and typically includes{" "}
          <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-sm">html</code> and{" "}
          <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-sm">body</code>{" "}
          structure. In Farm.js the framework injects the document shell; your layout receives{" "}
  ...
  return (
    <div className="min-h-screen">
      ...
      <section>
        ...
        <p className="mt-2 text-slate-600">
          Add a{" "}
          <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-sm">layout.tsx</code>{" "}
          inside any route segment. It wraps all pages under that segment.
        </p>
        <pre className="mt-4 overflow-x-auto rounded-lg bg-slate-900 p-4 text-sm text-slate-100">
          {`// app/docs/layout.tsx
import type { LayoutProps } from "@farmjs/core";
    ...
    <div className="flex gap-8">
      ...
      <article>{children}</article>
        ...
        <p className="mt-4 text-slate-600">
          All routes under{" "}
          <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-sm">/docs</code> will
          use this layout, with the root layout as the outer wrapper.
        </p>
      </section>
