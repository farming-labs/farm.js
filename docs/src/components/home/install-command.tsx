...
const commands: readonly CommandOption[] = [
  ...
  {
    label: "npm",
    command: "npx @farm.js/create-app@latest",
    brand: npmIconUrl,
    kind: "install",
  },
  {
    label: "Yarn",
    command: "yarn dlx @farm.js/create-app@latest",
    brand: yarnIconUrl,
    kind: "install",
  },
  {
    label: "pnpm",
    command: "pnpm dlx @farm.js/create-app@latest",
    brand: pnpmIconUrl,
    kind: "install",
  },
  {
    label: "Bun",
    command: "bunx @farm.js/create-app@latest",
    brand: bunIconUrl,
    kind: "install",
  },
];
