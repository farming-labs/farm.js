...
const commands: readonly CommandOption[] = [
  ...
  {
    label: "npm",
    command: "npx @farm.js/create-app@latest my-app",
    brand: npmIconUrl,
    kind: "install",
  },
  {
    label: "Yarn",
    command: "yarn dlx @farm.js/create-app@latest my-app",
    brand: yarnIconUrl,
    kind: "install",
  },
  {
    label: "pnpm",
    command: "pnpm create @farm.js/app my-app",
    brand: pnpmIconUrl,
    kind: "install",
  },
  {
    label: "Bun",
    command: "bunx @farm.js/create-app@latest my-app",
    brand: bunIconUrl,
    kind: "install",
  },
];
