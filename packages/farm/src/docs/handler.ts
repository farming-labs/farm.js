...
function renderFarmDocsBridgeCss(docs: FarmDocsResolvedConfig): string {
  ...
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .sidebar-folder-content > a[data-active]::after { left: calc(var(--fd-sidebar-guide-x) - var(--fd-sidebar-line-overlap) + var(--fd-sidebar-branch-gap)); width: calc(var(--fd-sidebar-link-x) - var(--fd-sidebar-guide-x) - var(--fd-sidebar-branch-gap) + var(--fd-sidebar-line-overlap)); }
    .sidebar-subgroup-title::after { left: calc(var(--fd-sidebar-guide-x) - var(--fd-sidebar-line-overlap) + var(--fd-sidebar-branch-gap)); width: calc(var(--fd-sidebar-sub-guide-x) - var(--fd-sidebar-guide-x) - var(--fd-sidebar-branch-gap) + var(--fd-sidebar-line-overlap) + var(--fd-sidebar-line-overlap)); }
    ...
    .sidebar-subgroup::before { content: ""; position: absolute; left: var(--fd-sidebar-sub-guide-x); top: 15px; bottom: 17px; width: 1px; background: var(--fd-sidebar-line-color); pointer-events: none; }
    ...
    .sidebar-subgroup-content a[data-active]::after { left: calc(var(--fd-sidebar-sub-guide-x) - var(--fd-sidebar-line-overlap)); width: calc(var(--fd-sidebar-sub-link-x) - var(--fd-sidebar-sub-guide-x) - var(--fd-sidebar-nested-icon-gap) + var(--fd-sidebar-line-overlap)); }
