...
function renderFarmDocsBridgeCss(docs: FarmDocsResolvedConfig): string {
  ...
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .sidebar-folder-content::before { content: ""; position: absolute; left: var(--fd-sidebar-guide-x); top: 0; bottom: 6px; width: 1px; background: var(--fd-sidebar-line-color); pointer-events: none; }
