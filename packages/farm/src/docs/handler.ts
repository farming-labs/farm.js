  ...
  return `
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 1020px) {
      :root { --fd-mobile-nav-height: 56px; --fd-sidebar-edge: 20px; --fd-sidebar-guide-x: 58px; --fd-sidebar-link-x: 88px; --fd-sidebar-sub-guide-x: 106px; --fd-sidebar-sub-link-x: 136px; }
