...
function renderFarmDocsBridgeCss(docs: FarmDocsResolvedConfig): string {
  ...
  return `
    ...
    :root { color-scheme: dark; --fd-sidebar-width: ${sidebarWidth}px; --fd-content-width: ${contentWidth}px; --fd-toc-width: 240px; --fd-docs-height: 100vh; --fd-docs-row-1: var(--fd-nav-height, 56px); --fd-docs-font-sans: var(--font-geist-sans, "Geist Sans", var(--font-sans, system-ui, -apple-system, sans-serif)); --fd-docs-font-mono: var(--font-geist-mono, "Geist Mono", var(--font-mono, ui-monospace, monospace)); --fd-font-sans: var(--fd-docs-font-sans); --fd-font-mono: var(--fd-docs-font-mono); --fd-pixel-rail-width: 12px; --fd-sidebar-edge: calc(var(--fd-pixel-rail-width) + 18px); --fd-sidebar-guide-x: calc(var(--fd-sidebar-edge) + 16px); --fd-sidebar-link-x: calc(var(--fd-sidebar-guide-x) + 22px); --fd-sidebar-sub-guide-x: calc(var(--fd-sidebar-guide-x) + 20px); --fd-sidebar-sub-link-x: calc(var(--fd-sidebar-link-x) + 20px); --fd-sidebar-line-color: color-mix(in srgb, var(--color-fd-border, hsl(0 0% 15%)) 88%, transparent); }
    * { box-sizing: border-box; }
    ...
    .sidebar-folder-content > a[data-active]::after, .sidebar-subgroup-title::after, .sidebar-subgroup-content a[data-active]::after { content: ""; position: absolute; top: 50%; height: 1px; background: var(--fd-sidebar-line-color); transform: translateY(-50%); pointer-events: none; }
    .sidebar-folder-content > a[data-active]::after, .sidebar-subgroup-title::after { left: var(--fd-sidebar-guide-x); width: calc(var(--fd-sidebar-link-x) - var(--fd-sidebar-guide-x) - 9px); }
    ...
    .sidebar-subgroup-content::before { content: ""; position: absolute; left: var(--fd-sidebar-sub-guide-x); top: 0; bottom: 15px; width: 1px; background: var(--fd-sidebar-line-color); pointer-events: none; }
    .sidebar-subgroup-content a[data-active]::after { left: var(--fd-sidebar-sub-guide-x); width: calc(var(--fd-sidebar-sub-link-x) - var(--fd-sidebar-sub-guide-x) - 9px); }
