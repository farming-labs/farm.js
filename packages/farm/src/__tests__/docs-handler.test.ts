...
describe("createFarmDocsHandler", () => {
  ...
  it("serves docs markdown files as HTML", async () => {
    ...
    expect(html).toContain("--fd-sidebar-line-overlap: 2px");
    ...
    expect(html).toContain(".sidebar-folder-content > a[data-active]::after { left: calc(var(--fd-sidebar-guide-x) - var(--fd-sidebar-line-overlap) + var(--fd-sidebar-branch-gap));");
    expect(html).toContain(".sidebar-subgroup-title::after { left: calc(var(--fd-sidebar-guide-x) - var(--fd-sidebar-line-overlap) + var(--fd-sidebar-branch-gap)); width: calc(var(--fd-sidebar-sub-guide-x) - var(--fd-sidebar-guide-x) - var(--fd-sidebar-branch-gap) + var(--fd-sidebar-line-overlap) + var(--fd-sidebar-line-overlap));");
    expect(html).toContain(
      ".sidebar-subgroup-content a[data-active]::after { left: calc(var(--fd-sidebar-sub-guide-x) - var(--fd-sidebar-line-overlap));",
    );
