 ...
 */
export type RoutePath = "/" | "/about" | "/api-demo" | "/api-demo-client" | "/boundaries/error" | "/boundaries/loading" | "/contact" | "/farm-query-client-demo" | "/farm-query-demo" | "/prefetch-e2e" | "/query-demo" | `/users/${string}`;
