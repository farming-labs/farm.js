      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-pink-900/30 border border-pink-500/50 rounded-lg p-4 mb-8">
          <p className="text-pink-200 text-sm">
            <strong>'use client'</strong> - This is a client component! All API calls happen in the
            browser.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          {/* Login API (POST) */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
            <h2 className="text-2xl font-semibold mb-4 text-yellow-400">POST /api/auth/login</h2>
            <button
              onClick={handleLogin}
            ...
            {loginResponse && (
              <div className="bg-gray-900 rounded p-4 font-mono text-sm">
                <pre className="text-green-400">{JSON.stringify(loginResponse, null, 2)}</pre>
              </div>
            )}
          ...
          {/* Create User (POST) */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
            <h2 className="text-2xl font-semibold mb-4 text-green-400">POST /api/users</h2>
            <button
              onClick={createUser}
            ...
            <p className="text-sm text-gray-400">Creates a new user and refreshes the users list</p>
          </div>
