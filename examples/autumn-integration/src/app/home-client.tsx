...
type ProductState =
  | { status: "loading"; products: AutumnCatalogProduct[]; message?: string }
  | { status: "ready"; products: AutumnCatalogProduct[]; message?: string }
  | { status: "error"; products: AutumnCatalogProduct[]; message: string };
...
const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      "Recurring Autumn subscription for the active organization",
      "Metered token usage reported directly from the dashboard",
      "Customer portal access for billing and payment methods",
    ],
    unavailableNote:
      "Add AUTUMN_PRO_MONTHLY_PLAN_ID or AUTUMN_PRO_YEARLY_PLAN_ID in .env.local to enable live Autumn checkout for this plan.",
  },
  {
    id: "business",
    name: "Business",
    ...
    unavailableNote:
      "Set AUTUMN_BUSINESS_MONTHLY_PLAN_ID and AUTUMN_BUSINESS_YEARLY_PLAN_ID to turn on live Business checkout in this demo.",
  },
] as const;
...
function getTokenPackProduct(products: AutumnCatalogProduct[]) {
...
export interface HomeClientProps {
  initialProducts?: AutumnCatalogProduct[];
}
...
export function HomeClient({ initialProducts = [] }: HomeClientProps) {
  ...
  const [billingStatus, setBillingStatus] = useState<AutumnBillingStatusResult | null>(null);
    ...
    async function loadProducts() {
      try {
        ...
        setProducts({
          ...
          products: initialProducts,
          message:
            error instanceof Error ? error.message : "Could not load the Autumn product catalog.",
        });
      }
    }
  ...
  return (
    <main className="page-shell page-shell-wide">
      <section className="hero">
        <span className="eyebrow">Autumn + Better Auth</span>
      ...
      <section className="card page-notice">
        ...
        <div className="link-grid">
          ...
          <a className="nav-card" href="/dashboard">
            ...
            <span>Switch owners, report usage, and inspect Autumn billing state.</span>
          </a>
        </div>
      ...
      <section className="card pricing-card-shell">
          <div className="pricing-header">
            <div className="pricing-heading">
              ...
              <p>
                ...
                when an Autumn plan is configured, and metered token pricing called out separately.
              </p>
            </div>
          ...
          {signedIn && activeOrganizationName ? (
            <div className="notice notice-success">
              ...
              {billingStatus?.customerId ? " • Autumn customer ready" : " • No Autumn customer yet"}
            </div>
          ) : null}

          <div className="pricing-grid pricing-grid-autumn">
              ...
              const additionalPricing =
                billingCycle === "month"
                  ? (product?.meterPrices ?? []).map(
                      (meterPrice: AutumnCatalogMeterPrice) =>
                    ...
                    <div className="pricing-list-section pricing-addon-section">
                      ...
                      {missingConfiguredProduct ? (
                        ...
                        <p className="pricing-note">
                          No live metered price is attached to this product yet. Autumn checkout can
            ...
            <article className="product-card utility-card">
              <div className="product-copy">
                ...
                <p>
                  ...
                  Autumn feature meter and billed from the live metered price attached to the selected
            ...
            {tokenPackProduct ? (
              <article className="product-card utility-card">
                <div className="product-copy">
                  ...
                  <p>
                    A separate Autumn purchase for prepaid usage packs or credits. Use it when you
          ...
          <div className="pricing-footnote">
            ...
            <p>
              Included usage is an app-side allowance from the active plan, while Autumn metered
              pricing comes from the live product configuration. To see usage affect the bill, the
              live Autumn subscription product must have a metered price attached to the same meter
