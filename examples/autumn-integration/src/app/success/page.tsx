  ...
  return (
    <main className="page-shell">
      <section className="hero">
        <span className="eyebrow">Autumn Checkout</span>
        <h1>Checkout Flow Complete</h1>
        <p>
          This page re-loads billing status from Autumn customer state and lets you
      ...
      <section className="playground-grid">
        ...
        <section className="card">
          <h2>Next Step</h2>
          <p>
            If the checkout created or updated an Autumn customer, you can open the
