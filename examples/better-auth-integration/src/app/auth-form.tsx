  ...
  return (
    <section className="card form-card">
      ...
      <form className="mock-form" onSubmit={submit}>
        ...
        <label>
          Email
          <input defaultValue="person@farmjs.dev" name="email" placeholder="person@farmjs.dev" type="email" />
        </label>
        <label>
          Password
          <input defaultValue="secret123" name="password" placeholder="••••••••" type="password" />
        </label>
        <button className="primary-button" disabled={!hydrated || pending} type="submit">
          {!hydrated ? "Loading client..." : pending ? "Working..." : mode === "sign-in" ? "Sign In" : "Sign Up"}
        </button>
      </form>
