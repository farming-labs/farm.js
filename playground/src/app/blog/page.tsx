    ...
    <div>
      ...
      >
        <p style={{ margin: 0, color: "#166534" }}>
          <strong>Routing Demo:</strong> This page demonstrates static content rendering. Try
          clicking on a blog post to see dynamic routing with <code>[slug]</code> parameters!
        </p>
      </div>
    </div>
  );
