      ...
      <body>
        <main class="canvas">
          ...
          <section class="frame">
            ...
            <footer class="footer">
              <div class="command"><span class="prompt">$</span><strong>pnpm --config.dlx-cache-max-age=0 --config.minimum-release-age=0 create @farm.js/app@beta</strong> my-app</div>
